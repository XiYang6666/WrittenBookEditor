...
from writtenbookeditor.plugins.lib_minecraft.font.genernal_loader import BitmapProvider
from writtenbookeditor.plugins.lib_minecraft.font.utils import print_bitmap

provider = BitmapProvider(
    ProviderFilter(False, False),
    ["data/test/font"],
    file="ascii.png",
    chars=[
        "\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000",
...
char_info = provider.get_char_info("a", ProviderFilter(False, False))
assert char_info is not None
print_bitmap(char_info.bitmap)
