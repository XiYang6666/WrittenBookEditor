...
with open("./data/font/unifont/unifont_all_no_pua-15.1.05.hex") as f:
    for line in f.readlines():
        ...
        bitmap_array = bitmap_array.astype(np.bool)
        assert is_bitmap(bitmap_array)
        unifont_map[char] = bitmap_array
...
def get_char_unifont_bitmap(char: str, jp: bool = False) -> Optional[Bitmap]:
